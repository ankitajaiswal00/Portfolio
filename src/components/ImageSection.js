        ...
        <div className="ImageSection">
            ...
            <div className="about-info">
                ...
                <p className="about-text">
                    ...
                    I believe in creating great web and android applications that have a strong machine learning foundation from enhancing productivity to creating solid solutions. The belief that motivates me to code and contribute to the community is that my solutions would directly affect the society in some way and might help in making it a better place to live.
                </p>
